---
name: analyze-root-causes-and-consequences-from-a-questi
description: "Analyze root causes and consequences from a question. Category: 🤔 Decision Making"
---
...
- **initial question**: Request this from the user if not provided
