---
name: reconcile-conflicting-stakeholder-requirements-int
description: "Reconcile conflicting stakeholder requirements into balanced design approach. Category: 🤝 Stakeholder Management"
---
...
- **stakeholder priorities**: Request this from the user if not provided
- **technical constraints**: Request this from the user if not provided
- **conflicting requirements**: Request this from the user if not provided
- **user research insights**: Request this from the user if not provided
- **project context**: Request this from the user if not provided
