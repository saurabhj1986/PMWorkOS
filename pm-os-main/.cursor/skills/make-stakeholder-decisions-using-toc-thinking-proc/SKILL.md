---
name: make-stakeholder-decisions-using-toc-thinking-proc
description: "Make stakeholder decisions using TOC thinking process. Category: 🤝 Stakeholder Management"
---
...
- **stakeholder info**: Request this from the user if not provided
