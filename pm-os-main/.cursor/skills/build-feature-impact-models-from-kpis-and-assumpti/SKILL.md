---
name: build-feature-impact-models-from-kpis-and-assumpti
description: "Build feature impact models from KPIs and assumptions. Category: 📊 Business Analysis"
---
...
- **kpis to estimate**: Request this from the user if not provided
- **feature info**: Request this from the user if not provided
