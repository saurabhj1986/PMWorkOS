---
name: analyze-product-decisions-from-anthropological-res
description: "Analyze product decisions from anthropological research insights. Category: 🔍 User Research"
---
...
- **role**: Request this from the user if not provided
- **user persona**: Request this from the user if not provided
- **topic**: Request this from the user if not provided
