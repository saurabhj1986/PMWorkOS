---
name: create-4-unique-interface-descriptions-from-a-sing
description: "Create 4 unique interface descriptions from a single image. Category: 🎨 Design & Prototyping"
---
...
- **image**: Request this from the user if not provided
