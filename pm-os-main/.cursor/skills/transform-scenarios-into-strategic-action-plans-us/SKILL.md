---
name: transform-scenarios-into-strategic-action-plans-us
description: "Transform scenarios into strategic action plans using adaptive planning. Category: 🎯 Product Strategy"
---
...
- **current state**: Request this from the user if not provided
- **ideal future**: Request this from the user if not provided
- **projected mess**: Request this from the user if not provided
- **ideal current state**: Request this from the user if not provided
