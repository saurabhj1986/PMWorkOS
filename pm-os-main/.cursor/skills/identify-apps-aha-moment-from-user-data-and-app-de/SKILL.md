---
name: identify-apps-aha-moment-from-user-data-and-app-de
description: "Identify app's \"aha moment\" from user data and app description. Category: 🔍 User Research"
---
...
- **app description**: Request this from the user if not provided
- **user data**: Request this from the user if not provided
