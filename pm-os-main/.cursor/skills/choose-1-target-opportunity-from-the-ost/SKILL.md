---
name: choose-1-target-opportunity-from-the-ost
description: "Choose 1 target opportunity from the OST. Category: 🤔 Decision Making"
---
...
- **ost json**: Request this from the user if not provided
