---
name: transform-shallow-personas-into-actionable-user-pr
description: "Transform shallow personas into actionable user profiles with tasks and constraints. Category: 🔍 User Research"
---
...
- **available user data**: Request this from the user if not provided
- **product context**: Request this from the user if not provided
- **existing persona**: Request this from the user if not provided
