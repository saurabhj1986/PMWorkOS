---
name: create-compelling-product-strategy-review-from-dra
description: "Create compelling product strategy review from draft documents and context. Category: 🎯 Product Strategy"
---
...
- **draft document**: Request this from the user if not provided
