---
name: transform-vision-statements-into-actionable-quarte
description: "Transform vision statements into actionable quarterly OKRs. Category: 🎯 Product Strategy"
---
...
- **vision statement**: Request this from the user if not provided
