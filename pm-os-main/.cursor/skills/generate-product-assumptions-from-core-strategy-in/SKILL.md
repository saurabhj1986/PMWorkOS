---
name: generate-product-assumptions-from-core-strategy-in
description: "Generate product assumptions from core strategy inputs. Category: 🔍 User Research"
---
...
- **core problem**: Request this from the user if not provided
- **product description**: Request this from the user if not provided
- **target user**: Request this from the user if not provided
