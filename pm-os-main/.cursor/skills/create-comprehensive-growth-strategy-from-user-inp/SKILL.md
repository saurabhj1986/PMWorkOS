---
name: create-comprehensive-growth-strategy-from-user-inp
description: "Create comprehensive growth strategy from user inputs. Category: 🎯 Product Strategy"
---
...
- **user inputs**: Request this from the user if not provided
