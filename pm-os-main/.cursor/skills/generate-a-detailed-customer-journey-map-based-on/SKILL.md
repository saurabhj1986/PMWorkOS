---
name: generate-a-detailed-customer-journey-map-based-on
description: "Generate a detailed customer journey map based on user behavior data. Category: 📊 Business Analysis"
---
...
- **user behavior data**: Request this from the user if not provided
