---
name: create-demo-narrative-showing-user-goals
description: "Create demo narrative showing user goals. Category: 🤝 Stakeholder Management"
---
...
- **audience**: Request this from the user if not provided
- **prototype**: Request this from the user if not provided
- **user goals**: Request this from the user if not provided
- **research insights**: Request this from the user if not provided
