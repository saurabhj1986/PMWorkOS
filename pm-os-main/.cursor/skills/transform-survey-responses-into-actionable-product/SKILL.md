---
name: transform-survey-responses-into-actionable-product
description: "Transform survey responses into actionable product improvements. Category: 🔍 User Research"
---
...
- **survey responses**: Request this from the user if not provided
