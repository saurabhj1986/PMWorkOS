---
name: create-expert-product-strategies-from-task-specifi
description: "Create expert product strategies from task-specific inputs. Category: 🎯 Product Strategy"
---
...
- **prd content**: Request this from the user if not provided
- **pm question**: Request this from the user if not provided
- **task type**: Request this from the user if not provided
