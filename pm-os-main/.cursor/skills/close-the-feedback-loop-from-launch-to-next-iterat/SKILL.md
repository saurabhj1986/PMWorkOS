---
name: close-the-feedback-loop-from-launch-to-next-iterat
description: "Close the feedback loop from launch to next iteration. Category: 📊 Business Analysis"
---
...
- **available data sources**: Request this from the user if not provided
- **current process**: Request this from the user if not provided
- **launch timeline**: Request this from the user if not provided
- **team structure**: Request this from the user if not provided
