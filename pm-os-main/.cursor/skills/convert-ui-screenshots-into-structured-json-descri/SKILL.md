---
name: convert-ui-screenshots-into-structured-json-descri
description: "Convert UI screenshots into structured JSON descriptions. Category: 🎨 Design & Prototyping"
---
...
- **screenshot**: Request this from the user if not provided
