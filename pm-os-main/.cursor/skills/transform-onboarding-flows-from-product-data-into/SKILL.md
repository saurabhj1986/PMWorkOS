---
name: transform-onboarding-flows-from-product-data-into
description: "Transform onboarding flows from product data into user success. Category: 📊 Business Analysis"
---
...
- **current onboarding process**: Request this from the user if not provided
