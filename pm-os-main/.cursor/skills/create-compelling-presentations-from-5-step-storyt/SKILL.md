---
name: create-compelling-presentations-from-5-step-storyt
description: "Create compelling presentations from 5-step storytelling framework. Category: 🗣️ Presentation & Communication"
---
...
- **current step**: Request this from the user if not provided
