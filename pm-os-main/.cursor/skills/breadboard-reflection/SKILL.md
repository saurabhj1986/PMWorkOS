...
> **External skill** — Source: [https://github.com/rjs/shaping-skills](https://github.com/rjs/shaping-skills) by rjs. Not maintained by prodmgmt.world. Run `./external-skills/update.sh` to pull the latest version.
