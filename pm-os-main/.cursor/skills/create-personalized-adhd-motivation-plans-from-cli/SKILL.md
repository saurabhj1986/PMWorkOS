---
name: create-personalized-adhd-motivation-plans-from-cli
description: "Create personalized ADHD motivation plans from client situations. Category: 🌱 Personal Productivity/Development"
---
...
- **client situation**: Request this from the user if not provided
