---
name: transform-leadership-intuition-into-data-driven-re
description: "Transform leadership intuition into data-driven research plans. Category: 🔍 User Research"
---
...
- **intuition**: Request this from the user if not provided
- **company context**: Request this from the user if not provided
