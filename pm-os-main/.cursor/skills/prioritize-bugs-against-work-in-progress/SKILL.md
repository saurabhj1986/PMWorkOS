---
name: prioritize-bugs-against-work-in-progress
description: "Prioritize bugs against work in progress. Category: 🤔 Decision Making"
---
...
- **bug description**: Request this from the user if not provided
- **current work**: Request this from the user if not provided
- **planned work**: Request this from the user if not provided
