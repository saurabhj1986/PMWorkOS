...
> **External skill** — Source: [https://github.com/zarazhangrui/frontend-slides](https://github.com/zarazhangrui/frontend-slides) by zarazhangrui. Not maintained by prodmgmt.world. Run `./external-skills/update.sh` to pull the latest version.
