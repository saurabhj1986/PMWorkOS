---
name: identify-flawed-solutions-from-customer-problem-an
description: "Identify flawed solutions from customer problem analysis. Category: 🎨 Design & Prototyping"
---
...
- **customer notes**: Request this from the user if not provided
