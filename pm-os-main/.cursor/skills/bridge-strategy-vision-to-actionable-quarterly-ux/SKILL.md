---
name: bridge-strategy-vision-to-actionable-quarterly-ux
description: "Bridge strategy vision to actionable quarterly UX decisions. Category: 🎯 Product Strategy"
---
...
- **design team capacity**: Request this from the user if not provided
- **existing design system**: Request this from the user if not provided
- **vision strategy**: Request this from the user if not provided
- **current quarter objectives**: Request this from the user if not provided
