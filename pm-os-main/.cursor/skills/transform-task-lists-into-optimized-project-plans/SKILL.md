---
name: transform-task-lists-into-optimized-project-plans
description: "Transform task lists into optimized project plans with contingencies. Category: 📅 Project Management"
---
...
- **task list**: Request this from the user if not provided
