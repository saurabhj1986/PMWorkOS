---
name: validate-aging-research-insights-before-reusing
description: "Validate aging research insights before reusing. Category: 🔍 User Research"
---
...
- **existing research**: Request this from the user if not provided
- **current context**: Request this from the user if not provided
- **time since research**: Request this from the user if not provided
