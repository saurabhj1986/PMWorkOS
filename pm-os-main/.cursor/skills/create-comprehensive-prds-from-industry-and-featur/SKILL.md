---
name: create-comprehensive-prds-from-industry-and-featur
description: "Create comprehensive PRDs from industry and feature specifications. Category: 📊 Business Analysis"
---
...
- **company name**: Request this from the user if not provided
- **development stage**: Request this from the user if not provided
- **industry**: Request this from the user if not provided
- **feature name**: Request this from the user if not provided
- **current knowledge**: Request this from the user if not provided
- **current solution**: Request this from the user if not provided
