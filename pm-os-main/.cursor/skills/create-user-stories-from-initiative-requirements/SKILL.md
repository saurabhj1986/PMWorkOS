---
name: create-user-stories-from-initiative-requirements
description: "Create user stories from initiative requirements. Category: 📊 Business Analysis"
---
...
- **initiative context**: Request this from the user if not provided
- **user story template**: Request this from the user if not provided
- **functionality description**: Request this from the user if not provided
