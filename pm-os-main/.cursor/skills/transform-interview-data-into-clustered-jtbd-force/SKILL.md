---
name: transform-interview-data-into-clustered-jtbd-force
description: "Transform interview data into clustered JTBD forces. Category: 🔍 User Research"
---
...
- **interview data**: Request this from the user if not provided
- **force type**: Request this from the user if not provided
