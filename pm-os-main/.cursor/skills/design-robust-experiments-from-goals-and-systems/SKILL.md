---
name: design-robust-experiments-from-goals-and-systems
description: "Design robust experiments from goals and systems. Category: 🔍 User Research"
---
...
- **experiment template**: Request this from the user if not provided
- **goal**: Request this from the user if not provided
- **system**: Request this from the user if not provided
