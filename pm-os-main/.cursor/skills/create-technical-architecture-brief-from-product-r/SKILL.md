---
name: create-technical-architecture-brief-from-product-r
description: "Create technical architecture brief from product requirements doc. Category: 💾 Technical"
---
...
- **prd**: Request this from the user if not provided
