---
name: create-trade-off-analysis-from-feature-priority-an
description: "Create trade-off analysis from feature priority and effort data. Category: 🤝 Stakeholder Management"
---
...
- **feature effort**: Request this from the user if not provided
- **stakeholder request**: Request this from the user if not provided
- **feature priority**: Request this from the user if not provided
