---
name: transform-product-ideas-into-detailed-sketch-descr
description: "Transform product ideas into detailed sketch descriptions for wireframes. Category: 🎨 Design & Prototyping"
---
...
- **product idea**: Request this from the user if not provided
- **additional details**: Request this from the user if not provided
