---
name: generate-effective-meeting-agendas-from-meeting-de
description: "Generate effective meeting agendas from meeting descriptions. Category: 📅 Project Management"
---
...
- **meeting description**: Request this from the user if not provided
