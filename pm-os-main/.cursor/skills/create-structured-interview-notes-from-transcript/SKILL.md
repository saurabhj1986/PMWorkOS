---
name: create-structured-interview-notes-from-transcript
description: "Create structured interview notes from transcript using flexible frameworks. Category: 🔍 User Research"
---
...
- **note taking mode**: Request this from the user if not provided
