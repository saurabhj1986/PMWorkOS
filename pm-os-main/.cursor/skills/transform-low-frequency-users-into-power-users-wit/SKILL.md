---
name: transform-low-frequency-users-into-power-users-wit
description: "Transform low-frequency users into power users with strategic transitions. Category: 🎯 Product Strategy"
---
...
- **product description**: Request this from the user if not provided
- **target use case**: Request this from the user if not provided
- **current use case**: Request this from the user if not provided
