---
name: create-structured-meeting-summaries-from-meeting-t
description: "Create structured meeting summaries from meeting transcript (IDEAS framework). Category: 📅 Project Management"
---
...
- **meeting transcript**: Request this from the user if not provided
