---
name: create-structured-conversation-summaries-from-meet
description: "Create structured conversation summaries from meeting transcripts. Category: 📅 Project Management"
---
...
- **conversation**: Request this from the user if not provided
