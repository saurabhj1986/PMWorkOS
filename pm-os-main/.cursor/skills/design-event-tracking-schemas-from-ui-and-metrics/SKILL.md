---
name: design-event-tracking-schemas-from-ui-and-metrics
description: "Design event tracking schemas from UI and metrics requirements. Category: 📊 Business Analysis"
---
...
- **ui description**: Request this from the user if not provided
- **metrics and behaviors**: Request this from the user if not provided
