---
name: diagnose-metric-drops-with-rigorous-stepwise-decom
description: "Diagnose metric drops with rigorous stepwise decomposition. Category: 📊 Business Analysis"
---
...
- **formula**: Request this from the user if not provided
- **timeframe**: Request this from the user if not provided
- **metric name**: Request this from the user if not provided
- **baseline value**: Request this from the user if not provided
- **current value**: Request this from the user if not provided
