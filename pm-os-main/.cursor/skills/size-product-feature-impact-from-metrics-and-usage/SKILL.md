---
name: size-product-feature-impact-from-metrics-and-usage
description: "Size product feature impact from metrics and usage data. Category: 📊 Business Analysis"
---
...
- **product feature**: Request this from the user if not provided
- **metrics**: Request this from the user if not provided
