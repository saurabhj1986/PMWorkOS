---
name: create-compelling-slide-decks-from-problem-stateme
description: "Create compelling slide decks from problem statements and context. Category: 🗣️ Presentation & Communication"
---
...
- **additional context**: Request this from the user if not provided
- **problem statement**: Request this from the user if not provided
...
**Build the deck:** After you have the slide outline, use the **frontend-slides** skill to turn it into a styled, animation-rich HTML presentation (single file, no PowerPoint required).
