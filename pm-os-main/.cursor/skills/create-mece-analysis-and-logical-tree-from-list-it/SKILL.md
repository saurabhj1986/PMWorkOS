---
name: create-mece-analysis-and-logical-tree-from-list-it
description: "Create MECE analysis and logical tree from list items. Category: 🤔 Decision Making"
---
...
- **list of items**: Request this from the user if not provided
