---
name: create-structured-product-hypotheses-from-product
description: "Create structured product hypotheses from product problems. Category: 🤔 Decision Making"
---
...
- **product problem**: Request this from the user if not provided
