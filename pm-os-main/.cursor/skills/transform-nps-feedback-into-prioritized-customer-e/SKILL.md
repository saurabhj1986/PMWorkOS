---
name: transform-nps-feedback-into-prioritized-customer-e
description: "Transform NPS feedback into prioritized customer experience initiatives. Category: 📊 Business Analysis"
---
...
- **nps feedback**: Request this from the user if not provided
