---
name: create-comprehensive-prds-from-product-information
description: "Create comprehensive PRDs from product information and assumptions. Category: 📊 Business Analysis"
---
...
- **prd known information**: Request this from the user if not provided
