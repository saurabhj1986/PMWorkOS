---
name: create-winning-strategies-from-industry-trends-and
description: "Create winning strategies from industry trends and company strengths. Category: 🎯 Product Strategy"
---
...
- **company**: Request this from the user if not provided
- **goal**: Request this from the user if not provided
- **trend**: Request this from the user if not provided
